...
saveRDS(res_total_human, file = paste0(results_path, "namibia_htmle_inc_total_human_sens_spzone_3km.RDS"))
...
saveRDS(res_total_mosq, file = paste0(results_path, "namibia_htmle_inc_total_mosq_sens_spzone_3km.RDS"))
...
saveRDS(res_total_hm, file = paste0(results_path, "namibia_htmle_inc_total_hm_sens_spzone_3km.RDS"))
...
saveRDS(res_spillover_human, file = paste0(results_path, "namibia_htmle_inc_spillover_human_sens_spzone_3km.RDS"))
...
saveRDS(res_spillover_mosq, file = paste0(results_path, "namibia_htmle_inc_spillover_mosq_sens_spzone_3km.RDS"))
...
saveRDS(res_spillover_hm, file = paste0(results_path, "namibia_htmle_inc_spillover_hm_sens_spzone_3km.RDS"))
