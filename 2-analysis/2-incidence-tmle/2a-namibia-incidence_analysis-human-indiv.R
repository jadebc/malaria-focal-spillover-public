...
saveRDS(res_total_human, file = paste0(results_path, "namibia_htmle_inc_total_human_indiv.RDS"))
...
saveRDS(res_spillover_human, file = paste0(results_path, "namibia_htmle_inc_spillover_human_indiv.RDS"))
...
saveRDS(res_direct_human, file = paste0(results_path, "namibia_htmle_inc_direct_human_indiv.RDS"))
