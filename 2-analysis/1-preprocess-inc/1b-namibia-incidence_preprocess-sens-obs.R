...
# load data ------
df_long <- readRDS(namibia_df_long_sens_obs_path)
df_short <- readRDS(namibia_df_short_sens_obs_path)
...
# save covariates
saveRDS(covarname_long, namibia_inc_covar_sens_obs_path) 
...
saveRDS(data_human_list, namibia_human_process_sens_obs_path)
saveRDS(data_mosq_list, namibia_mosq_process_sens_obs_path)
saveRDS(data_hm_list, namibia_hm_process_sens_obs_path)
