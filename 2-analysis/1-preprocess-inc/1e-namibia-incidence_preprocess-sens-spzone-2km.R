...
# load data ------
df_long <- readRDS(namibia_df_long_sens_spzone_2km_path)
df_short <- readRDS(namibia_df_short_sens_spzone_2km_path)
...
dropnames = c(
  ...
  "delta_pre_index_500m",             
  "delta_pre_index_1km",              
  "delta_pre_index_2km",              
  "delta_pre_index_3km",              
  "delta_age",                        
  "delta_concur_int_2000",            
  "delta_n_int_pre_recei",            
  "delta_concur_int_propdiffarm_2000",
...
saveRDS(covarname_long, namibia_inc_covar_sens_spzone_2km_path)
...
saveRDS(data_human_list, namibia_human_process_sens_spzone_2km_path)
saveRDS(data_mosq_list, namibia_mosq_process_sens_spzone_2km_path)
saveRDS(data_hm_list, namibia_hm_process_sens_spzone_2km_path)
