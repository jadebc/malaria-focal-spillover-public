...
# load data ------
df_long <- readRDS(namibia_df_long_sens_spzone_3km_path)
df_short <- readRDS(namibia_df_short_sens_spzone_3km_path)
...
dropnames = c(
  ...
  "delta_concur_int_3000",            
  "delta_concur_int_propdiffarm_3000",
...
saveRDS(covarname_long, namibia_inc_covar_sens_spzone_3km_path)
...
saveRDS(data_human_list, namibia_human_process_sens_spzone_3km_path)
saveRDS(data_mosq_list, namibia_mosq_process_sens_spzone_3km_path)
saveRDS(data_hm_list, namibia_hm_process_sens_spzone_3km_path)
