...
## 09-08-2021 for df_long, re-calc this variable 
...
saveRDS(df_count_int_concu_deliv, file = count_int_concu_deliv_l_path)
...
# load df_long version "df_count_int_concu_deliv"
df_count_int_concu_deliv <- readRDS(count_int_concu_deliv_l_path)
...
# fix one error in the cohort data, "RO27-6401" with ea RO27
# temp <- cohorts %>% filter(iid_combined == "RO27-6401")
...
saveRDS(df_all, namibia_df_long_path)
...
saveRDS(df_all_permute, namibia_df_long_permute_path)
...
saveRDS(df_deid, namibia_df_long_deid_path)
