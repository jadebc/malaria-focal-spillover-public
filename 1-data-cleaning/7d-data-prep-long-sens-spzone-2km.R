...
df_base <- readRDS(namibia_df_base_path_sens_spzone_2km)
...
saveRDS(df_all, namibia_df_long_sens_spzone_2km_path)
...
# saveRDS(df_all_permute, paste0(namibia_clean_path, "namibia_df_sens_spzone_2km_permute_long.RDS"))
